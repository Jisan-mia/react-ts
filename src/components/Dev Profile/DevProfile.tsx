...
const DevProfile = () => {
  ...
  const [editingProfile, setEditingProfile] = useState<devProfileType>({
    id: 0,
    name: "",
    title: "",
    description: "",
  ...
  const handleEditProfile = (profile: devProfileType) => {
    setEditingProfile({...profile})
    setIsEdit(devProfile.indexOf(profile))
  }
